...
def get_date_window(start_date, end_date, mapping_window_step=100, mapping_window_step_unit='ms', bound=(None,None), closed=None):
  ...
  return pd.date_range(start=min_range, end=max_range, freq=str(mapping_window_step) + ' ' + mapping_window_step_unit, closed=closed).to_pydatetime()